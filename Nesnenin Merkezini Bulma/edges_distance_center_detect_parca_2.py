# -*- coding: utf-8 -*-
"""
Created on Thu Nov  2 10:14:49 2023
...
for filename in os.listdir(path):
    if filename.endswith("Image_2_i.bmp"):
        ...
        _,threshold = cv2.threshold(gray_image, 57, 255, cv2.THRESH_BINARY_INV)
...
#cnt = contours[0]
        ...
        cv2.imwrite("parca_2_i.jpg", image)
        cv2.waitKey(0)
